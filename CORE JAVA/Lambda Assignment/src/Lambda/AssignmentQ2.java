...
public class AssignmentQ2 {
	public static void main(String[] args) {
		orderDetails obj0 = new orderDetails(17000, "Accepted");
		orderDetails obj1 = new orderDetails(7000, "Accepted");
		orderDetails obj2 = new orderDetails(25000, "notAccepted");
		orderDetails obj3 = new orderDetails(3000, "notAccepted");
		orderDetails obj4 = new orderDetails(65000, "Accepted");
