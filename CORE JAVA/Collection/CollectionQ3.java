...
public class CollectionQ3 {
	public static void main(String[] args)
	{
		...
		if(select.equals("a"))
		{
			...
			emp.add(new Employee(101,"Vignesh","CSE",100000));
            emp.add(new Employee(102,"Vishal","ECE",75000));
            emp.add(new Employee(103,"Rithwik","CSE",40000));
            emp.add(new Employee(104,"Krishna","AERO",80000));
