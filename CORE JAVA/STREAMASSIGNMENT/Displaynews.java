...
public class Displaynews {
	public static void main(String[] args) {
		List<News> news= Arrays.asList(
				new News(101, "ABP", "Vignesh", "Cases are now less, the budget for this year is " ),
				new News(102, "NDTV", "ayush", "Lionel Messi wins record 7th Ballon D'or, budget has officially been declared"),
				new News(103, "AAJ TAK", "akshay","School and Colleges to reopen shortly, all offices also to open"),
				new News(104, "ABP", "rithwik", "India wins by 7 wickets, Many new policies have been added to the budget, the budget policy would help India grow drastically"),
				new News(105, "NDTV", "krishna", "Formula 1 pre season testing done!! Red Bull could win the constructors title this year!!")
				);
