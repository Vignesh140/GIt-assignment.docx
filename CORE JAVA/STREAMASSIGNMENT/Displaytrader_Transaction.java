...
public class Displaytrader_Transaction {
	public static void main(String[] args) {
		Trader t1=new Trader("Vignesh", "Kolkata");
		Trader t2=new Trader("suresh", "Pune");
		Trader t3=new Trader("akshay", "Lucknow");
		Trader t4=new Trader("ayush", "Pune");
		Trader t5=new Trader("rithwik", "Delhi");
		Trader t6=new Trader("Krishna", "Delhi");
